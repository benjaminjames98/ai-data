...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    <div class="w3-col s4">
      <div class="w3-circle w3-margin-right w3-black w3-display-container" style="width:46px; height: 46px">
  ...
  <div class="w3-bar-block">
    ...
    <a href="<?= $PAGE_RECONCILER ?>dashboard.php" class="w3-bar-item w3-button w3-padding">
      <i class="fas fa-chart-line fa-fw"></i>Dashboard</a>
    <?php if ($PAGE_TYPE == 'per_users') : ?>
      <a href="<?= $PAGE_RECONCILER ?>users.php" class="w3-bar-item w3-button w3-padding">
    ...
    <?php endif; ?>
    <?php if ($per_churches) : ?>
      <a href="<?= $PAGE_RECONCILER ?>churches/churches_frontend.php" class="w3-bar-item w3-button w3-padding">
        <i class="fas fa-church fa-fw"></i> Churches</a>
    <?php endif;
    if ($per_education) : ?>
      <a href="<?= $PAGE_RECONCILER ?>cohorts/education_frontend.php" class="w3-bar-item w3-button w3-padding">
        <i class="fas fa-graduation-cap fa-fw"></i> Cohorts</a>
    <?php endif;
    if ($per_bread) : ?>
      <a href="<?= $PAGE_RECONCILER ?>bread/bread_churches_frontend.php" class="w3-bar-item w3-button w3-padding">
        <i class="fas fa-cookie-bite fa-fw"></i> Bread - Management</a>
      <a href="<?= $PAGE_RECONCILER ?>bread/bread_status_all_frontend.php" class="w3-bar-item w3-button w3-padding">
        <i class="fas fa-cookie-bite fa-fw"></i> Bread - State</a>
      <a href="<?= $PAGE_RECONCILER ?>bread/bread_status_frontend.php" class="w3-bar-item w3-button w3-padding">
