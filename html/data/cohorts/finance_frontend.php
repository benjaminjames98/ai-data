...
<div class='w3-row'>
    ...
    <section class='w3-card w3-margin w3-third w3-mobile'>
        <header class='w3-container w3-theme'>
            ...
            <button class='w3-button w3-xlarge w3-right'
                    title='refresh payments' onclick='readPayments();'>
                &#8635;
            </button>
        </header>
        <div id='div_pmt_switch' class='w3-responsive'
             style='max-height: 20vh; overflow-y: scroll'></div>
    </section>
    <!-- Payment -->
    ...
    <section class='w3-card w3-margin w3-rest w3-mobile'>
        <header class='w3-container w3-theme'>
            ...
            <button class='w3-button w3-xlarge w3-right' title='refresh payees'
                    onclick='readPayees();'>&#8635;
            </button>
        </header>
        <div id='div_pye_switch' class='w3-responsive'
             style='max-height: 20vh; overflow-y: scroll'></div>
    </section>
    <!-- Payees -->
</div>
...
<section class='w3-card w3-margin'>
    ...
    <div class='w3-row'>
        ...
        <section class='w3-card w3-margin w3-padding w3-third w3-mobile'>
            <div class='w3-row'>
                <input id='ipt_det_nam' placeholder='name'
                       class='w3-input w3-threequarter w3-border w3-mobile'
                       type='text'>
                <div id='div_det_sav_switch'></div>
            </div>
            <div class='w3-row w3-section'>
                <input id='ipt_det_abn' placeholder='ABN'
                       class='w3-input w3-threequarter w3-border w3-mobile'
                       type='text'>
            </div>
        ...
        <section class='w3-card w3-margin w3-rest w3-mobile'>
            <header class='w3-container w3-text-theme'>
                ...
                <button class='w3-button w3-large w3-right'
...
<div id='mdl_pmt_crt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_pmt_crt');">&times;
            </button>
            <h4 class='w3-left'>Create Payment</h4>
        </header>
        <div class='w3-padding'>
            <!-- content -->
            <input class='w3-input w3-border w3-section' id='ipt_pmt_des'
                   placeholder='description' maxlength='128'>
            <input class='w3-input w3-border w3-section' id='ipt_pmt_amt'
                   placeholder='amount' maxlength='20'>
            <input class='w3-input w3-border w3-section' id='ipt_pmt_gst'
                   placeholder='gst' maxlength='20'>
            <div class='w3-row w3-section'>
                <button class='w3-btn w3-theme w3-right w3-margin-left'
                        onclick='createPayment();'>Create
                </button>
                <button class='w3-btn w3-theme w3-right'
                        onclick="_close('mdl_pmt_crt');">Cancel
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_pmt_red' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_pmt_red');">&times;
            </button>
        ...
        <div class='w3-padding'>
            ...
            <div class='w3-row w3-section'>
                <button class='w3-btn w3-theme w3-right'
                        onclick="_close('mdl_pmt_red');">Close
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_pye_crt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_pye_crt');">&times;
            </button>
            <h4 class='w3-left'>Create Payee</h4>
        </header>
        <div class='w3-padding'>
            <!-- content -->
            <input class='w3-input w3-border w3-section' id='ipt_pye_nam'
                   placeholder='name' maxlength='64'>
            <input class='w3-input w3-border w3-section' id='ipt_pye_abn'
                   placeholder='ABN' maxlength='11'>
            <div class='w3-row w3-section'>
                <button class='w3-btn w3-theme w3-right w3-margin-left'
                        onclick='createPayee();'>Create
                </button>
                <button class='w3-btn w3-theme w3-right'
                        onclick="_close('mdl_pye_crt');"> Close
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_pye_sdt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_pye_sdt');">&times;
            </button>
        ...
        <div class='w3-padding'>
            ...
            <div class='w3-row w3-section'>
                <button class='w3-btn w3-theme w3-right'
                        onclick="_close('mdl_pye_sdt');"> Close
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_rct_crt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_rct_crt');">&times;
            </button>
        ...
        <div class='w3-padding'>
            ...
            <input class='w3-input w3-border w3-section' id='ipt_rct_des2'
                   placeholder='description'>
            <input class='w3-input w3-border w3-section' id='ipt_rct_amt'
                   placeholder='amount'>
            ...
            <div class='w3-row w3-section'>
                ...
                <button class='w3-btn w3-theme w3-right w3-margin-right'
                        onclick="_close('mdl_rct_crt');">Cancel
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_rct_red' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_rct_red');">&times;
            </button>
        ...
        <div class='w3-padding'>
            ...
            <div class='w3-row w3-section'>
                ...
                <button class='w3-btn w3-theme w3-right w3-margin-right'
                        onclick="_close('mdl_rct_red');"> Close
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_ivc_crt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_ivc_crt');">&times;
            </button>
        ...
        <div class='w3-padding'>
            ...
            <div class='w3-section'>
                ...
                <textarea id='ipt_ivc_chg' class='w3-input w3-border'
                          maxlength='1024' autocomplete='false' rows='8'
                          placeholder='notes'
                          style='resize: vertical'> </textarea>
            </div>
            <input class='w3-input w3-border w3-section' id='ipt_ivc_due'
                   placeholder='due days (default 15)'>
            <div class='w3-row w3-section'>
                <div id='div_ivc_crt_switch'></div>
                <button class='w3-btn w3-theme w3-right w3-margin-right'
                        onclick="_close('mdl_ivc_crt');">Cancel
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_ivc_red' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_ivc_red');">&times;
            </button>
        ...
        <div class='w3-padding'>
            ...
            <div class='w3-row w3-section'>
                ...
                <button class='w3-btn w3-theme w3-right w3-margin-right'
                        onclick="_close('mdl_ivc_red');">Close
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_phn_crt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_phn_crt');">&times;
            </button>
            <h4 class='w3-left'>Create Phone</h4>
        </header>
        <div class='w3-padding'>
            <!-- content -->
            <input class='w3-input w3-border w3-section' id='ipt_phn_phn'
                   placeholder='phone number'>
            <div class='w3-row w3-section'>
                <div id='div_phn_crt_switch'></div>
                <div id='div_phn_udt_switch'></div>
                <button class='w3-btn w3-theme w3-right w3-margin-right'
                        onclick="_close('mdl_phn_crt');">Cancel
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_eml_crt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_eml_crt');">&times;
            </button>
            <h4 class='w3-left'>Create Email</h4>
        </header>
        <div class='w3-padding'>
            <!-- content -->
            <input class='w3-input w3-border w3-section' id='ipt_eml_eml'
                   placeholder='email'>
            <div class='w3-row w3-section'>
                <div id='div_eml_crt_switch'></div>
                <div id='div_eml_udt_switch'></div>
                <button class='w3-btn w3-theme w3-right w3-margin-right'
                        onclick="_close('mdl_eml_crt');">Cancel
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_add_crt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_add_crt');">&times;
            </button>
            <h4 class='w3-left'>Create Address</h4>
        </header>
        <div class='w3-padding'>
            <!-- content -->
            <input class='w3-input w3-border w3-section' id='ipt_add_ln1'
                   placeholder='line 1'>
            <input class='w3-input w3-border w3-section' id='ipt_add_ln2'
                   placeholder='line 2'>
            <input class='w3-input w3-border w3-section' id='ipt_add_sub'
                   placeholder='suburb'>
            ...
            <input class='w3-input w3-border w3-section' id='ipt_add_pcd'
                   placeholder='Post Code'>
            <div class='w3-row w3-section'>
                <div id='div_add_crt_switch'></div>
                <div id='div_add_udt_switch'></div>
                <button class='w3-btn w3-theme w3-right w3-margin-right'
                        onclick="_close('mdl_add_crt');">Cancel
                </button>
            </div>
            <!-- content -->
        </div>
