var _URL = "../../../ajax_backend/education_backend.php?";
...
function updateCohortInfo(id) {
  ...
  postRequest("update_cohort_info", foo, [id, nam, ldr, umb, atv, cbk, nbk, pgm]);
}
...
function prepModal(mdl, id, type) {
  if (mdl === "mdl_sdt_crt") {
    function readPayees(obj) {
      ...
      document.getElementById("ipt_sdt_crt_pye").options[0].selected = "selected";
  ...
  if (mdl === "mdl_cht_crt") {
    function cohortPrep(obj) {
      ...
      document.getElementById("ipt_cht_crt_ldr").options[0].selected = "selected";
      document.getElementById("ipt_cht_crt_cbk").innerHTML = obj.boks;
      document.getElementById("ipt_cht_crt_cbk").options[0].selected = "selected";
      document.getElementById("ipt_cht_crt_nbk").innerHTML = obj.boks;
      document.getElementById("ipt_cht_crt_nbk").options[0].selected = "selected";
      document.getElementById("ipt_cht_crt_pgm").innerHTML = obj.pgms;
      document.getElementById("ipt_cht_crt_pgm").options[0].selected = "selected";
