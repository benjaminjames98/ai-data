    ...
    <section class='w3-card w3-margin w3-third w3-mobile'>
        <header class='w3-container w3-theme'>
            ...
            <button class='w3-button w3-xlarge w3-right'
                    ...
                    onclick="prepModal('mdl_sdt_crt');">+
            </button>
            <button class='w3-button w3-xlarge w3-right'
                    title='refresh students' onclick='readStudents();'>&#8635;
            </button>
        </header>
        <div id='div_sdt_switch' class='w3-responsive'
    ...
    <section class='w3-card w3-margin w3-rest w3-mobile'>
        <header class='w3-container w3-theme'>
            ...
            <button class='w3-button w3-xlarge w3-right'
                    ...
                    onclick="prepModal('mdl_cht_crt');">+
            </button>
            <button class='w3-button w3-xlarge w3-right' title='refresh cohort'
                    onclick='readCohorts();'>&#8635;
            </button>
        </header>
        <div id='div_cht_switch' class='w3-responsive'
             style='max-height: 20vh; overflow-y: scroll'></div>
    </section>
    <!-- Cohort -->
</div>
            ...
            <div class='w3-row'>
                <div class='w3-half'>
                    ...
                    <section class='w3-card w3-margin'>
                        ...
                        <div class='w3-margin'>
                            <input id='ipt_sdt_nam' placeholder='name'
                                   class='w3-input w3-border w3-section'
                                   type='text'>
                            <textarea id='ipt_sdt_not'
                                      class='w3-input w3-border-left'
                                      maxlength='1024' autocomplete='false'
                                      rows='8'
                                      placeholder='notes'
                ...
                <div class='w3-rest'>
                    ...
                    <section class='w3-card w3-margin'>
                        ...
                        <div class='w3-margin'>
                            <select class='w3-input w3-section' id='ipt_sdt_pye'
                                    name='payee'>
                    ...
                    <section class='w3-card w3-margin'>
                        <header class='w3-container w3-text-theme'>
                            ...
                            <button class='w3-button w3-large w3-right'
                                    ...
                                    onclick="prepModal('mdl_crt_ctc', undefined, 'eml');">
                                E
                            </button>
                            <button class='w3-button w3-large w3-right'
                                    title='create new phone'
                                    onclick="prepModal('mdl_crt_ctc', undefined, 'phn');">
                                P
                            </button>
                            <button class='w3-button w3-large w3-right'
                                    title='create new address'
                                    onclick="prepModal('mdl_crt_ctc', undefined, 'add');">
                                A
                            </button>
                        </header>
            ...
            <div class='w3-row'>
                    ...
                    <section class='w3-card w3-margin'>
                        ...
                        <div class='w3-container'>
                            <div class='w3-section'>
                                ...
                                <input id='ipt_cht_nam' placeholder='name'
                                       class='w3-input w3-border' type='text'>
                            </div>
                            <div class='w3-section'>
                                <label for='ipt_cht_umb'>Unlisted
                                    Members</label>
                                <input id='ipt_cht_umb'
                                       placeholder='unlisted members'
                                       class='w3-input w3-border' type='text'>
                            </div>
                            <div class='w3-section'>
                                <input id='ipt_cht_atv' class='w3-check'
                                       type='checkbox'>
                                <label for='ipt_cht_atv'>Active</label>
                            </div>
                            <div class='w3-section w3-row-padding'>
                                <div class='w3-half w3-mobile'>
                                    <label for='ipt_cht_cbk'>Current
                                        Book:</label>
                                    <select class='w3-input' id='ipt_cht_cbk'
                                            name='option'>
                                ...
                                <div class='w3-rest w3-mobile'>
                                    ...
                                    <select class='w3-input' id='ipt_cht_nbk'
                                            name='option'>
                                        <option value='no'>Acts</option>
                                        <option value='yes'>Paulines</option>
                                    </select>
                            ...
                            <div class='w3-section w3-row-padding'>
                                <div class='w3-half w3-mobile'>
                                    ...
                                    <select class='w3-input' id='ipt_cht_ldr'
                                            name='option'>
                                ...
                                <div class='w3-rest w3-mobile'>
                                    ...
                                    <select class='w3-input' id='ipt_cht_pgm'
                                            name='option'>
                ...
                <div class='w3-rest'>
                    ...
                    <section class='w3-card w3-margin'>
                        ...
                        <div class='w3-margin'>
             <textarea id='ipt_cht_not' class='w3-input w3-border-left'
                       maxlength='1024' autocomplete='false' rows='6'
...
<div id='mdl_sdt_crt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_sdt_crt');">&times;
            </button>
        ...
        <div class='w3-padding'>
            ...
            <div class='w3-section'>
                ...
                <input class='w3-input w3-border' id='ipt_sdt_crt_nam'
                       placeholder='name'>
            </div>
            <div class='w3-section'>
            ...
            <div class='w3-row w3-section'>
                <button class='w3-btn w3-theme w3-right w3-margin-left'
                        onclick='createStudent();'>Create
                </button>
                <button class='w3-btn w3-theme w3-right w3-margin-right'
                        onclick="_close('mdl_sdt_crt');">Cancel
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_cht_crt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_cht_crt');">&times;
            </button>
        ...
        <div class='w3-padding'>
            ...
            <div class='w3-section'>
                ...
                <input id='ipt_cht_crt_nam' placeholder='name'
                       class='w3-input w3-border' type='text'>
            </div>
            <div class='w3-section'>
            ...
            <div class='w3-section'>
                ...
                <input id='ipt_cht_crt_umb' placeholder='unlisted members'
                       class='w3-input w3-border' type='text'>
            </div>
            <div class='w3-section'>
            ...
            <div class='w3-row w3-section'>
                <button class='w3-btn w3-theme w3-right w3-margin-left'
                        onclick='createCohort();'>Create
                </button>
                <button class='w3-btn w3-theme w3-right w3-margin-right'
                        onclick="_close('mdl_cht_crt');">Cancel
                </button>
            </div>
            <!-- content -->
        </div>
...
<div id='mdl_cht_sdt' class='w3-modal'>
    <div class='w3-modal-content w3-card'>
        <header class='w3-container w3-theme'>
            <button class='w3-button w3-xlarge w3-right'
                    onclick="_close('mdl_cht_sdt');">&times;
            </button>
        ...
        <div class='w3-padding'>
            ...
            <div class='w3-row w3-section'>
                ...
                <button class='w3-btn w3-theme w3-right w3-margin-right'
                        onclick="_close('mdl_cht_sdt');">Cancel
                </button>
            </div>
            <!-- content -->
        </div>
