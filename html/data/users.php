...
<head>
    ...
    <script type="text/JavaScript" src="resources/js/create_new_user.js"></script>
    <script type="text/JavaScript" src="resources/js/user_permission_controller.js"></script>
...
<script>
    window.onload = function () {
        UserPermissionController(el('per_user'), el('per_container'), el('per_button'));
