...
<div id='sidebar' class='w3-white w3-bar-block w3-card w3-animate-left'>
  <div class='w3-bar-item w3-border-bottom w3-animate-left'>
    <button id='close_sidebar' class='w3-text-red w3-button w3-xlarge w3-animate-left'
        onclick="_close('sidebar')" title='close_sidebar' style='width: 60px'>
      <i class='fas fa-times-circle'></i>
    </button>
    <button id='church_create' class='w3-text-theme w3-button w3-xlarge w3-animate-left'
        title='new church' style='width: 60px'>
      <i class='fas fa-church'></i>
    </button>
    <button id='person_create' class='w3-text-theme w3-button w3-xlarge w3-animate-left'
        title='new person' style='width: 60px'><i class='fas fa-user'></i>
    </button>
    <button id='toggle_content' class='w3-text-theme w3-button w3-xlarge w3-animate-left'
        title='switch between churches and people' style='width: 60px'>
      <i class='fas fa-exchange-alt'></i>
    </button>
    <button id='refresh_db' class='w3-text-theme w3-button w3-xlarge w3-animate-left'
        title='refresh data' style='width: 60px'><i class='fas fa-sync'></i>
    </button>
    <button id='show_emails' class='w3-text-theme w3-button w3-xlarge w3-animate-left'
  ...
  <div id='entity_search' class='w3-bar-item w3-border-bottom w3-animate-left'>
...
<div id='infobar' class='w3-white w3-bar-block w3-card w3-animate-right'>
  <!---- Info ---->
  <section id='info' class='shake w3-bar-item w3-bar-block w3-card' style='padding: 0'>
    <section class='w3-bar-item w3-bar-block w3-card' style='padding: 0'>
      <section class='w3-bar-item w3-bar-block w3-card' style='padding: 0'>
        <!---- Details ---->
        <div class='w3-bar-item w3-row w3-card' style='margin-top: 0'>
          <h5 id='info_header' class='w3-xlarge w3-col l6 m6 s12'></h5>
          <button class='w3-button w3-xlarge w3-right-align w3-right w3-col w3-text-red'
              onclick="_close('infobar')" title='close_infobar' style='width: 60px'
              id='close_infobar'>
            <i class='fas fa-times-circle'></i>
          </button>
          <button class='w3-button w3-xlarge w3-right-align w3-right w3-col w3-text-theme'
              title='refresh' style='width: 60px' id='refresh_entity'>
            <i class='fas fa-sync'></i>
          </button>
          <button class='w3-button w3-xlarge w3-right-align w3-right w3-col w3-text-theme'
              title='scroll to' style='width: 60px' id='scroll_btn'>
            <i class='fas fa-eye'></i>
          </button>
        </div>
        <div id='details_switch'></div>
        <button id='details_save' class='w3-bar-item w3-btn w3-theme' style='text-align: center'>
          Save
        </button>
      ...
      <div class='w3-bar-item' style='padding: 0'>
        <button id='church_website' class='w3-button w3-xlarge w3-right w3-text-theme'
            title='new website'><i class='fas fa-globe'></i>
        </button>
        <button id='church_phone' class='w3-button w3-xlarge w3-right w3-text-theme'
            title='new phone'><i class='fas fa-phone'></i>
        </button>
        <button id='church_email' class='w3-button w3-xlarge w3-right w3-text-theme'
            title='new email'><i class='fas fa-envelope'></i>
        </button>
        <button id='church_address' class='w3-button w3-xlarge w3-right w3-text-theme'
    ...
    <div class='w3-bar-item' style='padding: 0'>
      <button id='info_role' class='w3-button w3-xlarge w3-right w3-text-theme'
...
<div class='b2-main'>
  ...
  <div id='entity_div' style='overflow-y: auto'>
    <ul id='entity_list' class='w3-container' style='list-style-type: none;'>
    </ul>
  </div>
  ...
  <div class='w3-modal-content w3-card w3-white'>
    ...
    <section id='modal_content' class='w3-panel w3-bar-block'>
      <label class='w3-bar-item'>Name:
        <input id='input_1' class='w3-input' placeholder='name' autocomplete='no'>
      </label>
    </section>
    <section class='w3-panel w3-padding'>
      <button id='modal_save' class='w3-theme w3-btn w3-right w3-margin-left'>Save</button>
      <button id='modal_cancel' class='w3-grey w3-btn w3-right' onclick='clearModal()'>Close</button>
    </section>
  </div>
</div>
