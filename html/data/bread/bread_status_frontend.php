...
<section class='w3-card w3-margin w3-padding w3-row'>
  ...
  <select class='w3-col l7 m10 s12 w3-select w3-border' id='sel_rgn' title='select region'></select>
  <button class='w3-col l4 m12 s12 w3-btn w3-theme' id='btn_red_rgn'>Fetch Deliveries</button>
</section>
