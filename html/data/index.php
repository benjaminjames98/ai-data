    ...
    <div class="w3-panel">
      <form action="../../includes/login_process.php" method="post" name="login_form">
        ...
        <div class="w3-panel">
          ...
          <input class="w3-input w3-border-bottom w3-border-green" type="password" name="password" id="password"/>
        </div>
        <div class="w3-panel">
          <input class="w3-btn w3-theme" type="button" value="Login" style="width: 100%"
